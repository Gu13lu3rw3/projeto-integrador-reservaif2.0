CREATE DATABASE IF NOT EXISTS reservaif;
USE reservaif;
...
CREATE TABLE SALA (
    ...
    status_manutencao VARCHAR(50) NOT NULL DEFAULT 'Disponível'
);
...
CREATE TABLE PROBLEMA (
    ...
    status_problema VARCHAR(50) NOT NULL DEFAULT 'Pendente',
...
('Guilherme Silva', 'guilherme@ifpi.edu.br', '$2b$12$LKbEym.0O1GEXGK5Q/pM6ueUJmUfZNQJouF0JifNGpls4yJASFEW.', 'Admin'),
('Carlos Eduardo', 'carlos@ifpi.edu.br', '$2b$12$LKbEym.0O1GEXGK5Q/pM6ueUJmUfZNQJouF0JifNGpls4yJASFEW.', 'Coordenador'),
('Antônio Marcos', 'antonio@ifpi.edu.br', '$2b$12$LKbEym.0O1GEXGK5Q/pM6ueUJmUfZNQJouF0JifNGpls4yJASFEW.', 'Professor'),
('Equipe Manutenção', 'manutencao@ifpi.edu.br', '$2b$12$LKbEym.0O1GEXGK5Q/pM6ueUJmUfZNQJouF0JifNGpls4yJASFEW.', 'Manutenção');
