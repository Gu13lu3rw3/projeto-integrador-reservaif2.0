...
from controllers.notificacao_controller import listar_notificacoes, marcar_como_lida, deletar_notificacao
from controllers.disponibilidade_controller import consultar_disponibilidade, filtrar_disponibilidade
from controllers.auth_controller import login, processar_login, logout, dashboard
...
def adicionar_rotas(app):
    ...
    app.add_url_rule('/notificacoes/marcar_lida', view_func=marcar_como_lida)
    app.add_url_rule('/notificacoes/deletar', view_func=deletar_notificacao)

    app.add_url_rule('/disponibilidade', view_func=consultar_disponibilidade)
    app.add_url_rule('/disponibilidade/filtrar', view_func=filtrar_disponibilidade, methods=['POST'])

    app.add_url_rule('/login', view_func=login)
    app.add_url_rule('/processar_login', view_func=processar_login, methods=['POST'])
